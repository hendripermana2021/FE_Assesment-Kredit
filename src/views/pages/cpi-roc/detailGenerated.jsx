...
const DetailGenerated = ({ generated }) => {
  ...
  const renderCpiData = () => {
    return generated.cpi_data?.map((values, index) => (
          ...
          <DialogContent>
            <Grid container spacing={3}>
              ...
              <Grid item xs={12} md={6}>
                <TextField fullWidth label="Name Nasabah" variant="outlined" value={generated.nasabah?.name_nasabah} required readOnly />
              </Grid>
              <Grid item xs={12} md={6}>
                <TextField
                  fullWidth
              ...
              {generated.cpi_data && renderCpiData()}
...
DetailGenerated.propTypes = {
  generated: PropTypes.object.isRequired // Prop type for kriteria object
};
