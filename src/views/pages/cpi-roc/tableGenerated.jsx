...
const GeneratedTable = () => {
  ...
  const exportToPDF = () => {
    ...
    doc.text('Result Data Ajuan (Generated by ROC and CPI)', 14, 10);

    // Ambil data tabel
    const tableColumn = ['ID', 'Name Nasabah', 'Gender', 'NIK', 'Pengaju', 'Date Add', 'CPI Result', 'Rank', 'Status'];
    const tableRows = [];

    ajuan.forEach((value, index) => {
      const rowData = [
        index + 1,
          ...
          <Card variant="outlined" sx={{ boxShadow: 3, padding: '2em' }}>
            <Grid container spacing={2}>
              ...
              <Grid item xs={4} md={4} sm={2} sx={{ textAlign: 'end' }}>
                ...
                <Button variant="contained" color="info" onClick={() => exportToPDF()} sx={{ marginLeft: '3em' }}>
                  Generated Report
                </Button>
              </Grid>
            </Grid>
